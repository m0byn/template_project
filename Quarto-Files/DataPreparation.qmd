...
-   Load data and do essential preparations which are identical for every other manipulation. The data is saved to .arrow and .parquet and should be imported in other quarto files.
...
-   Two options: 1) draw only a sample, 2) import full dataset
